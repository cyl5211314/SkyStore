...
public class ParticularHomeAdapter2 extends RecyclerView.Adapter<ParticularHomeAdapter2.ViewHolder> implements View.OnClickListener{
    ...
    public ParticularHomeAdapter2(Context context, List<ParticularData.DatasBean.GoodsListBean> list) {
        this.context = context;
        this.list = list;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view = View.inflate(context, R.layout.particularadapter2,null);
